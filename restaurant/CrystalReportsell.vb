...
Public Class CrystalReportsell
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "restaurant.CrystalReportsell.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportsell
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportsell = New CrystalReportsell()
        rpt.Site = Me.Site
        Return rpt
    End Function
